...
{selectedForecast && (
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto mt-8">
            ...
            <p><strong>🌡️ Max Temp:</strong> {selectedForecast.maxTemp}°C</p>
            <p><strong>🌡️ Min Temp:</strong> {selectedForecast.minTemp}°C</p>
            <p><strong>🌬️ Wind Speed:</strong> {selectedForecast.windSpeed} km/h</p>
            <button
